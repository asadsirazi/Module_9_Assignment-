<main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            <form action="<?php echo e(url('/contact')); ?>" method="post" role="form" class="php-email-form" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              <div class="row">
              ...
              <div class="my-3">
                ...
                <div class="sent-message"><?php echo e($success??""); ?></div>
              </div>
  ...
  </main><!-- End #main --><?php /**PATH D:\Laravel\MyPortfolio\resources\views/Components/contact.blade.php ENDPATH**/ ?>